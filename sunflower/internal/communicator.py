...
class Communicator():
    ...
    def __init__(self, comNumber):
        ...
        :return:
        '''
        self.serialPort = comNumber
        # self.serialChannel = serial.Serial(comNumber, 9600, timeout=1)
    ...
    def getPosition(self, isDisp=True):
        ...
        bytesCommandCode = bytes.fromhex(self.READPOSITION)
        self.__send(bytesCommandCode=bytesCommandCode)
    ...
    def __send(self, bytesCommandCode):
        time.sleep(0.1)
        self.serialChannel.write(bytes.fromhex(bytesCommandCode))
    ...
    def reset(self):
        ...
        :return:
        '''
        cmd = self.__generateComd(0, 43, True, True)
