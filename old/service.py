...
class service:
    def __init__(self, config):
        ...
        self.__calculator = calculator(lat=self.__config.getValue('lat'), lon=self.__config.getValue('lon'),
                                       ...
                                       innerStarConfig=self.__config.getValue(key='target'))
    ...
    def connectTelescope(self):
        ...
        :return:
        '''
        self.__communicator = Communicator(comNumber=self.__config.getValue('comNumber'))
    ...
    def setCOM(self, comNumber):
        ...
        try:
            ...
            self.__communicator = Communicator(comNumber=comNumber)
