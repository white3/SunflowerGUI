...
def parse_constellations(lines):
    ...
    Each name is a 3-letter constellation abbreviation; each target is an
    integer Hipparcos catalog number.  See :ref:`neowise-chart` for an
    example of how to combine this data with the Hipparcos target catalog
...
def parse_star_names(lines):
    ...
    with the target name.  Do not depend on the tuple having only length
