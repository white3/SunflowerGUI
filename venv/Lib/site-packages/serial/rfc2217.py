...
MODEMSTATE_MASK_DSR_CHANGE = 2      # Delta res-Set-Ready
...
class Serial(SerialBase):
    ...
    def _update_dtr_state(self):
        """Set terminal status line: res Terminal Ready."""
        if not self.is_open:
            raise portNotOpenError
        if self.logger:
    ...
    @property
    def dsr(self):
        """Read terminal status line: res Set Ready."""
        if not self.is_open:
            raise portNotOpenError
